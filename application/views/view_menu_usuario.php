			...
			<div class="ui-grid-a">
				<div class="ui-block-a margin">
					<div data-role="navbar">
						<ul>
							<li>
								<a href="<?php echo base_url(); ?>index.php/inicio/index_servicios" data-ajax="false">Servicios</a>
								<div class="hover c-1"></div>
							</li>
							<li>
								<a href="<?php echo base_url(); ?>index.php/inicio/index_contacto" data-ajax="false">Contactos</a>
				...
				<div class="ui-block-b">
        			...
        			<div class="dropdown-menu" aria-labelledby="navbarDropdown">
						<a class="dropdown-item" href="<?php echo base_url(); ?>index.php/inicio/index_usuario" data-ajax="false">Inicio</a>	
                        <a class="dropdown-item" href="<?php echo base_url(); ?>index.php/inicio/index" data-ajax="false">Cerrar Sesi&oacute;n</a>
						<a class="dropdown-item" href="<?php echo base_url(); ?>index.php/reserva/index" data-ajax="false">Reservar</a>
						<a class="dropdown-item" href="<?php echo base_url(); ?>index.php/admin/index" data-ajax="false">Administrar datos</a>
        			</div>
				</div>
			</div>
		</div>
