        ...
        <div class="ui-grid-a">
            <div class="ui-block-a">
                <div class="box">
                    ...
                    <a href="<?php echo base_url(); ?>index.php/reserva/index_registro" data-ajax="false" class="link">
                    <div class="boton">
            ...
            <div class="ui-block-b">
                <div class="box">
                    ...
                    <a href="<?php echo base_url(); ?>index.php/reserva/index_servicios" data-ajax="false" class="link">
                    <div class="boton">
